...
import net.venom.springboot.util.ROLE;
...
public class PostController {
    ...
    //getUrl method to generate url from Title, and this Title we can convert into dash (---)
    ...
    //handler method to handel edit post form submit request
    ...
    //handler Method to handel delete Post Request
    ...
    //handler Method to handel view Post Request
    ...
    //handler Method to handel search blog Post Request
    //localhost:8080/admin/post/search?query=forests
